...
class HopperIntakeSubsystem : public frc2::SubsystemBase {
 public:
  /**
   * Picks up game pieces
  */
  HopperIntakeSubsystem();
  ...
  void SetHopperIntakeMotorPower(double power);
 ...
 private:
  ...
  // Motor Controllers
  rev::spark::SparkMax m_hopperIntakeSparkMax;
